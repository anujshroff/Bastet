...
BEGIN
    ...
    VALUES (N'20250330045219_InitialMigration', N'10.0.2');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250406031528_AddHostIpAssignment', N'10.0.2');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260130070800_AddDataProtectionKeys', N'10.0.2');
END;
